...
| [Native Shell Layout Contract](./native-shell-layout-contract.md) | Approved shared caption/sidebar geometry, visibility and readable terminal titles | Active |
...
| [Git Host Contract](./git-host-contract.md) | Local/WSL/SSH repository authority, literal file resolution, write leases and uncertain reconciliation | Active |
| [Navigation Catalog Contract](./navigation-catalog-contract.md) | Shared Local/WSL/SSH worktree discovery and Orca-style Quick Open routing | Active |
